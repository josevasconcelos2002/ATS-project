...
public class Vintage implements Serializable {
    ...
    public void add_admin() throws ArtigoExistenteException {
    ...
    public void add_trasportadoras() {
        this.adicinonarTransportadora("Fedex", 10, 20, 30, 0.23, 0.50, true, 3);
        this.adicinonarTransportadora("Feliz", 1, 2, 3, 0.23, 0.15, false, 1);
    }

    public void add_poo() throws ArtigoExistenteException {
        this.adicionaUtilizador("joaogamer", "joao", "Braga", 123456, "joao");
        String id = this.gestor_Artigos.criar_artigo_sapatilhas("Confortáveis", "Nike AIR", 250, true, 2, 10, 1L, 2, 38,
                true, "Branca", 2022, true, 0.0);
        String id1 = this.gestor_Artigos.criar_artigo_sapatilhas("Leves", "Puma", 80, true, 0, 0, 2L, 2L, 37, false,
                "Azul", 2023, false, 0.0);
        String id2 = this.gestor_Artigos.criar_artigo_sapatilhas("Resistentes", "Reebok", 90, false, 1, 5, 2L, 2L, 39,
                true, "Cinza", 2022, false, 20.0);
        String id3 = this.gestor_Artigos.criar_artigo_sapatilhas("Estilosas", "Vans", 70, true, 0, 0, 2L, 2, 40, true,
                "Vermelha", 2023, false, 0.0);
        String id4 = this.gestor_Artigos.criar_artigo_sapatilhas("Duráveis", "New Balance", 110, false, 2, 8, 2L, 2L,
                38, false, "Rosa", 2022, false, 0.0);
        String id5 = this.gestor_Artigos.criar_artigo_sapatilhas("Moda casual", "Converse", 60, true, 0, 0, 2L, 2L, 37,
                false, "Cinza/Preto", 2023, false, 10.0);
    ...
    public void povoamento() throws ArtigoExistenteException {
        ...
        if (this.gestor_Utilizadores.existeIdUtilizador("joaogamer") == false)
            this.add_poo();
