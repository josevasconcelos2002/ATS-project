...
public class Malas_ESTest extends Malas_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "Transportadora: ", 1, "Transportadora: ", artigo_Estado0, 2, artigo_Avaliação0, "[t/AiYQK[", "C\u00F3digo: ", "C\u00F3digo: ", (-1473.2), 1, "[t/AiYQK[");
  ...
  public void test02()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "{pfa#{QY?=", (-1), "I3Mi->ax&x`CbY@z]", artigo_Estado0, 0, artigo_Avaliação0, "I3Mi->ax&x`CbY@z]", "Dimens\u00F5es: ", "", 770.0, (-982.4), "{pfa#{QY?=");
  ...
  public void test04()  throws Throwable  {
      ...
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-583.3033F), (String) null, 2, "c.$JDjD]2g/}<2E6,zR", artigo_Estado0, 2, artigo_Avaliação0, "c.$JDjD]2g/}<2E6,zR", "", "q", 0.0, 2, "=?!$W[OB'9#pZd5+#6");
  ...
  public void test06()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 4517.984F, "Model.Artigo$Estado", 113, "Model.Artigo$Estado", artigo_Estado0, 4640, artigo_Avaliação0, "Model.Artigo$Estado", "Model.Artigo$Estado", "Preco Final: ", 2505.0, (-1.0), "Model.Artigo$Estado");
  ...
  public void test09()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-1939.1083F), "Material: ", (-1988), "sO", artigo_Estado0, (-1988), artigo_Avaliação0, "Material: ", "J", "Model.Artigo$Estado", (-1988), (-307.0), "");
      int int0 = malas0.getAno_da_colecao();
  ...
  public void test11()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-1561.838F), "Material: ", 1, "@\"#R6H#N:_{hdb0", artigo_Estado0, 0, artigo_Avaliação0, "Material: ", "@\"#R6H#N:_{hdb0", "", (-1561.838F), 1, "BLVsLm]~3hB");
      malas0.setId(0);
      Malas malas1 = malas0.clone();
  ...
  public void test13()  throws Throwable  {
      ...
      Malas malas0 = new Malas(malas_Tipos_Malas0, 30.0F, "/8ECNLep", (-1), "/8ECNLep", artigo_Estado0, 3542, artigo_Avaliação0, "Avalia\u00E7\u00E3o: ", "/8ECNLep", "/8ECNLep", 30.0F, (-1), "BYHl_n/Ub4qY");
      Malas malas1 = malas0.clone();
  ...
  public void test18()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.BOM;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 1768.5623F, "", 784, "", artigo_Estado0, 0, artigo_Avaliação0, "", "", "", 0.0, 1.0, ",`@");
  ...
  public void test19()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "'|bdQyvQ", 1, "", artigo_Estado0, 3, artigo_Avaliação0, "'|bdQyvQ", "", "'|bdQyvQ", 0.0, 0.5, "");
      String string0 = malas0.getMaterial();
      assertEquals(0.0F, malas0.getDim(), 0.01F);
  ...
  public void test20()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-2593.65F), "Ew9!kL(YJb&0NWx]Sh", 0, "Model.Artigo$Avalia\u00E7\u00E3o", artigo_Estado0, 0, artigo_Avaliação0, "Ew9!kL(YJb&0NWx]Sh", "7S?E=", "'Bt+:%te_K:foF>?x", (-2011.0), 0, "Model.Artigo$Avalia\u00E7\u00E3o");
      int int0 = malas0.getAno_da_colecao();
