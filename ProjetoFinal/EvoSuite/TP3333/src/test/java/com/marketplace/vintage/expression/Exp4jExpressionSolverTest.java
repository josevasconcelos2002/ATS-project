...
public class Exp4jExpressionSolverTest {
    ...
    void isValid() {
        ...
        List<String> variables = Arrays.asList("itemsPrice");
    ...
    void defaultExpression() {
        ...
        BigDecimal result = expressionSolver.solve(expression,
                new HashMap<String, BigDecimal>() {{
                    put(VintageConstants.EXPEDITION_PRICE_EXPRESSION_BASE_PRICE_VARIABLE, BigDecimal.valueOf(100.0));
                    put(VintageConstants.EXPEDITION_PRICE_EXPRESSION_TAX_VARIABLE, BigDecimal.valueOf(0.1));
                }});
