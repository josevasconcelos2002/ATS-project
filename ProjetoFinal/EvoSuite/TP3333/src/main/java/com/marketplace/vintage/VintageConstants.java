...
public class VintageConstants {
    ...
    public static final List<String> DEFAULT_EXPEDITION_PRICE_EXPRESSION_VARIABLES = Arrays.asList(EXPEDITION_PRICE_EXPRESSION_BASE_PRICE_VARIABLE, EXPEDITION_PRICE_EXPRESSION_TAX_VARIABLE);
