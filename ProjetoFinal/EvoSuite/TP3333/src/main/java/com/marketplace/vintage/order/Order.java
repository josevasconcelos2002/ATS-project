...
public class Order implements Serializable {
    ...
    public List<OrderedItem> getOrderedItemsByParcelCarrier(String parcelCarrierName) {
        return orderedItems.stream()
                .filter(orderedItem -> orderedItem.getParcelCarrierName().equals(parcelCarrierName))
    ...
    public BigDecimal getParcelCarrierShippingCost(String parcelCarrierName) {
        ...
        for (InvoiceLine invoiceLine : this.getInvoiceLines()) {
            if (invoiceLine instanceof ParcelShipmentCostInvoiceLine) {
                ParcelShipmentCostInvoiceLine shipmentCostInvoiceLine = (ParcelShipmentCostInvoiceLine) invoiceLine;
