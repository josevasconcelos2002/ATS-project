...
public abstract class ParcelCarrier implements Serializable {
    ...
    public BigDecimal getShippingCost(ExpressionSolver expressionSolver, int itemsSize) {
        ...
        Map<String, BigDecimal> expressionVariables = new HashMap<>();
        expressionVariables.put(VintageConstants.EXPEDITION_PRICE_EXPRESSION_BASE_PRICE_VARIABLE, expeditionBasePrice);
        expressionVariables.put(VintageConstants.EXPEDITION_PRICE_EXPRESSION_TAX_VARIABLE, expeditionTax);
