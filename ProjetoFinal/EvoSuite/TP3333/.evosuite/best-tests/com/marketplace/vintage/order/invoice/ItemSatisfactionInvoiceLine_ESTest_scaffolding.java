...
public class ItemSatisfactionInvoiceLine_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.marketplace.vintage.order.invoice.ItemSatisfactionInvoiceLine"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ItemSatisfactionInvoiceLine_ESTest_scaffolding.class.getClassLoader() ,
      "impl.SapatilhasItem",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ItemSatisfactionInvoiceLine_ESTest_scaffolding.class.getClassLoader()); 
