...
public class OrderedItem_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.marketplace.vintage.order.OrderedItem"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OrderedItem_ESTest_scaffolding.class.getClassLoader() ,
      "com.marketplace.vintage.order.OrderedItem"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OrderedItem_ESTest_scaffolding.class.getClassLoader()); 
