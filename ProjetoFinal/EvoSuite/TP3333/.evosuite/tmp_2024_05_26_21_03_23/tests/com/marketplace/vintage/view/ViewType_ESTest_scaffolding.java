...
public class ViewType_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.marketplace.vintage.view.ViewType"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ViewType_ESTest_scaffolding.class.getClassLoader() ,
      "com.marketplace.vintage.view.ViewType"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ViewType_ESTest_scaffolding.class.getClassLoader()); 
