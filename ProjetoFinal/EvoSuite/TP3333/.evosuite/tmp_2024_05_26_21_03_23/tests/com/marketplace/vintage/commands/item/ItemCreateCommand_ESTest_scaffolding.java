...
public class ItemCreateCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.marketplace.vintage.commands.item.ItemCreateCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ItemCreateCommand_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.marketplace.vintage.commands.item.ItemCreateCommand$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ItemCreateCommand_ESTest_scaffolding.class.getClassLoader()); 
