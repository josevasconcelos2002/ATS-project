...
public class Artigo_ESTest extends Artigo_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Sapatilhas sapatilhas0 = new Sapatilhas((-1460), true, "Preco Final: ", localDate0, sapatilhas_Tipos_Sapatilhas0, "GK0`&JJ3,D3g<:N+c", artigo_Estado0, (-1460), artigo_Avaliação0, "3POqj", "Ano da cole\u00E7\u00E3o: ", "3POqj", (-1460), (-297.532F), "GK0`&JJ3,D3g<:N+c");
      Sapatilhas sapatilhas1 = new Sapatilhas((-1460), false, "Descri\u00E7\u00E3o: ", localDate0, sapatilhas_Tipos_Sapatilhas0, "kwK~~AN", artigo_Estado0, (-1460), artigo_Avaliação0, "0> DRDp,XXP+aZ5<MaK", "Material: ", "~ekgt:d[~$}u>6", 0.0, (-1460), "Material: ");
  ...
  public void test06()  throws Throwable  {
      ...
      Sapatilhas sapatilhas0 = new Sapatilhas(1, true, "", localDate0, sapatilhas_Tipos_Sapatilhas0, (String) null, artigo_Estado0, 1, artigo_Avaliação0, "Model.Artigo", "", "", 1, 0.0, "");
  ...
  public void test07()  throws Throwable  {
      ...
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-2007.7224F), "", 0, "", artigo_Estado0, 2, artigo_Avaliação0, "Cor: ", "}\"j@L#kA", (String) null, 0, 1611.54, "");
  ...
  public void test08()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-297.532F), "Descri\u00E7\u00E3o: ", (-1460), "Ano da cole\u00E7\u00E3o: ", artigo_Estado0, (-1460), artigo_Avaliação0, "Descri\u00E7\u00E3o: ", "Descri\u00E7\u00E3o: ", "Descri\u00E7\u00E3o: ", (-297.532F), (-1460), "@5Y)9W+3pO,9!R4");
  ...
  public void test09()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-1.0F), (String) null, 967, (String) null, artigo_Estado0, 967, artigo_Avaliação0, "4w:Flr", "4w:Flr", (String) null, 967, 967, "");
      String string0 = malas0.getTransportadora();
  ...
  public void test10()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 826.6F, "\"", 0, "\"", artigo_Estado0, 0, artigo_Avaliação0, (String) null, "\"", "PREMIUM", 826.6F, 0, "PREMIUM");
  ...
  public void test13()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.BOM;
      TShirt tShirt0 = new TShirt(tShirt_Tamanho0, tShirt_Padrao0, "\"Rf*lrlgr", artigo_Estado0, (-1), artigo_Avaliação0, (String) null, "}a![?[ePC9d8xV", "", (-280.0), (-280.0), "q");
      double double0 = tShirt0.getPrecoBase();
      assertEquals(0, tShirt0.getNumeroDonos());
  ...
  public void test15()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-1070.2695F), "`m`[", (-606), "O:t;g/5]I4}H", artigo_Estado0, (-606), artigo_Avaliação0, (String) null, "O:t;g/5]I4}H", "", (-1070.2695F), (-1070.2695F), "");
  ...
  public void test16()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "7yDTn,:LEed-++3", 45, "", artigo_Estado0, 45, artigo_Avaliação0, ">#-wss", "-K'<o%>H*6aVUh~", "Material:", 0.0, 45, "-K'<o%>H*6aVUh~");
  ...
  public void test20()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, (-6214), (String) null, (-2843), "Tipo: ", artigo_Estado0, 408, artigo_Avaliação0, (String) null, "cCO{ipkPP%", "T/$", 1.0, (-3039.313), "U1ugvqdLSTJV=Y");
  ...
  public void test21()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 1.0F, "{Su:(r4kh", 0, "{Su:(r4kh", artigo_Estado0, 0, artigo_Avaliação0, "S", (String) null, (String) null, 1.0F, 1.0F, "DwrrdM");
      String string0 = malas0.getDescricao();
      assertEquals(1, malas0.getId());
      assertEquals(0, malas0.getNumeroDonos());
  ...
  public void test22()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "NORMAL", (-707), (String) null, artigo_Estado0, 2147483645, artigo_Avaliação0, "Model.Malas", "NORMAL", "N\u00FAmero de Donos: ", 0.0F, 2147483645, (String) null);
  ...
  public void test24()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.NOVO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Sapatilhas sapatilhas0 = new Sapatilhas(0, true, (String) null, localDate0, sapatilhas_Tipos_Sapatilhas0, (String) null, artigo_Estado0, 1, artigo_Avaliação0, "", (String) null, (String) null, 749.82702860895, (-358.37768), "V+[>)[Q<UgG#");
  ...
  public void test25()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.IMPECÁVEL;
      TShirt tShirt0 = new TShirt(tShirt_Tamanho0, tShirt_Padrao0, "chnyP/&", artigo_Estado0, (-1), artigo_Avaliação0, "Cor: ", "Cor: ", "Data de Lancamento: ", 251.68, (-2091.5628781534), "SATISFAT\u00D3RIO");
      ...
      assertEquals("SATISFAT\u00D3RIO", tShirt0.getTransportadora());
  ...
  public void test29()  throws Throwable  {
      ...
      Artigo.Estado artigo_Estado0 = Artigo.Estado.USADO;
      Artigo.Avaliação artigo_Avaliação0 = Artigo.Avaliação.SATISFATÓRIO;
      Malas malas0 = new Malas(malas_Tipos_Malas0, 0.0F, "Tipo de mala: ", 2, "Tipo de mala: ", artigo_Estado0, 2, artigo_Avaliação0, "Tipo de mala: ", "Tipo de mala: ", "uTq<@tt.{bS", 644.907, 0.0F, "]mMj0bDgv}@H! }d7j:");
